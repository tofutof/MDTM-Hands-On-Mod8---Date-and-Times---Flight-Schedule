<?php include 'includes/header.php'; ?>
    ...
    <div class="world-clock-box">
        <h4 style="margin-left: 20px;">Current World Times</h4>
        <div class="tz-flex">
            <?php 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="time-block">
                            <p><strong>DEP:</strong> <?= $depart_obj->format('M j, g:i A'); ?></p>
                            <p><strong>ARR:</strong> <?= $arrive_obj->format('M j, g:i A'); ?></p>
                            <span style="font-size: 10px; color: gray;">TZ: <?= $dest_tz; ?></span>
                        </div>
